...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('.buttons.style8', { style: 'zoom-in', speed: 500, intensity: 10, threshold: 1, delay: 0, state: true, replay: false });
		...
		onvisible.add('h1.style22, h2.style22, h3.style22, p.style22', { style: 'zoom-in', speed: 500, intensity: 2, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('form.style1', { style: 'zoom-out', speed: 500, intensity: 0, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('form.style5', { style: 'zoom-out', speed: 500, intensity: 0, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('#text94', { style: 'zoom-in', speed: 500, intensity: 2, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('#links84', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('form.style3', { style: 'zoom-out', speed: 500, intensity: 0, threshold: 3, delay: 125, state: true, replay: false });
		onvisible.add('#links02', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#links43', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		...
		onvisible.add('#links83', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		...
		onvisible.add('#links41', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		...
		onvisible.add('#links35', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		...
		onvisible.add('#links42', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		...
		onvisible.add('.links.style19', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#links03', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#links87', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		...
		onvisible.add('#links101', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
