...
(function() {
	...
	// Initialize "On Visible" animations.
		...
		onvisible.add('#links15', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#links58', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#links94', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#links101', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#links102', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		onvisible.add('#links103', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		...
		onvisible.add('#links77', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
		...
		onvisible.add('#links08', { style: 'flip-forward', speed: 1375, intensity: 5, threshold: 3, delay: 0, state: true, replay: false });
